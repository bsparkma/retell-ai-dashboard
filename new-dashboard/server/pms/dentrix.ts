 ...
 * NexHealth provides a unified API layer for Dentrix scheduling data.
 *
...
class NotImplementedError extends Error {
  constructor(method: string) {
    super(`DentrixAdapter.${method} is not yet implemented. Requires NexHealth middleware integration.`);
